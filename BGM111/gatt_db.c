...
uint8_t bg_gattdb_attribute_field_60_data[12]={0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_attributes_map[])={
    ...
    {.uuid=0x0007,.permissions=0x807,.datatype=0x03,.min_key_size=0x00,.configdata={.flags=0x02,.index=0x0d}},
